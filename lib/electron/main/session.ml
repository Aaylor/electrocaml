...
class type cookies = object
  ...
  method on_changed : unit -> unit             (* TODO *)
  method get : unit -> unit -> unit            (* TODO *)
  method set : unit -> unit -> unit            (* TODO *)
  method remove : unit -> unit -> unit -> unit (* TODO *)
end
...
class type web_request = object
  method instance : instance
  method on_before_request : ?filter:unit -> unit -> unit      (* TODO *)
  method on_before_send_headers : ?filter:unit -> unit -> unit (* TODO *)
  method on_send_headers : ?filter:unit -> unit -> unit        (* TODO *)
  method on_headers_received : ?filter:unit -> unit -> unit    (* TODO *)
  method on_response_started : ?filter:unit -> unit -> unit    (* TODO *)
  method on_before_redirect : ?filter:unit -> unit -> unit     (* TODO *)
  method on_completed : ?filter:unit -> unit -> unit           (* TODO *)
  method on_error_occurred : ?filter:unit -> unit -> unit      (* TODO *)
end
...
class type session = object
  ...
  method clear_cache : unit -> unit (* TODO *)
  method clear_storage_data : ?options:unit -> ?callback:unit -> unit -> unit (* TODO *)
  method flush_storage_data : unit -> unit                           (* TODO *)
  method resolve_proxy : unit -> unit -> unit                        (* TODO *)
  method set_download_path : unit -> unit                            (* TODO *)
  method enable_network_emulation : unit -> unit                     (* TODO *)
  method disable_network_emulation : unit -> unit                    (* TODO *)
  method set_certificate_verify_proc : unit -> unit                  (* TODO *)
  method set_permission_request_handler : unit -> unit               (* TODO *)
  method clear_host_resolver_cache : ?callback: unit -> unit -> unit (* TODO *)
  method allow_ntlm_credentials_for_domains : unit -> unit           (* TODO *)
  method get_user_agent : unit -> unit                               (* TODO *)
  method get_blob_data : unit -> unit -> unit                        (* TODO *)
end
